...
llxHeader('','Modulo Descuentos','','','','',$morejs,$morecss,0,0);
 ...
 <!-- Page Content -->
    <div class="container-fluid " id="cont_principal">
            ...
            <div class="row">
                <h3>Reporte comprobantes de Clientes</h3> <hr>
            </div>
            ...
            <div class="col-md-5">
                ...
                <button type="button" class="btn btn-primary btn-block" id="search_btn"><span class="glyphicon glyphicon-search"></span> Buscar</button>
                </div>
...
<script src="js/app/mainClientes.js"></script>